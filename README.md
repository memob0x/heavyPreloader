...
![Node.js CI](https://github.com/memob0x/thread-fetcher/workflows/Node.js%20CI/badge.svg)

⚙️ **thread-fetcher.js** is a small script (~4,0kB) that lets you programmatically fetch whatever resource type in a **separate thread** leaving the main one free to "concentrate" on animations and other visually noticeable changes in order to enhance the perceived performance to the end user.
...
-   [Loading HTML](https://codesandbox.io/s/thread-fetcher-1592t/#/html/)
-   [Loading Stylesheets](https://codesandbox.io/s/thread-fetcher-1592t/#/css/)
-   [Loading Scripts](https://codesandbox.io/s/thread-fetcher-1592t/#/javascript/)
-   [Lazily Loading Images](https://codesandbox.io/s/thread-fetcher-1592t/#/images/)
-   [Manual Handling (JSON files)](https://codesandbox.io/s/thread-fetcher-1592t/#/json/)

## [HTML](https://codesandbox.io/s/thread-fetcher-1592t/#/html/)
...
Here's the full [demo](https://codesandbox.io/s/thread-fetcher-1592t/#/html/).

## [CSS](https://codesandbox.io/s/thread-fetcher-1592t/#/css/)
...
Here's the full [demo](https://codesandbox.io/s/thread-fetcher-1592t/#/css/).
...
## [Lazy Images](https://codesandbox.io/s/thread-fetcher-1592t/#/images/)
...
Here's the full [demo](https://codesandbox.io/s/thread-fetcher-1592t/#/images/).

## [Manual Handling](https://codesandbox.io/s/thread-fetcher-1592t/#/images/)
...
Here's the full [demo](https://codesandbox.io/s/thread-fetcher-1592t/#/json/).
