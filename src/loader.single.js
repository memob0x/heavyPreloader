import { generateInstanceID, stringContains, stringStartsWith, hyphensToCamelCase, nodelistToArray, isInArray } from './loader.utils';

import { pluginInstance, supportedExtensions, supportedTags } from './loader.settings';

import { intersectionObserverSupported, pictureElementSupported } from './loader.client';

import { CustomEvent, detachEventListener, attachEventListener } from './loader.events';

import { privateCache } from './loader.cache';

import { isVisible, isHTMLElement, isLoaded, isFullyBuffered, isBroken } from './loader.element';
